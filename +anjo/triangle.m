...
%ANJO.TRIANGLE Plots triangles.
%   
%   ANJO.TRIANGLE(AX,...) Plots in axes AX instead of current axis.
%
%   ANJO.TRIANGLE(x,y) Like plot(x,y) but with triangles as markers.
%
%   ANJO.TRIANGLE(x,y,angle) Specifies rotation angle of the triangle,
