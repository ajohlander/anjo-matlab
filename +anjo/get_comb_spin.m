...
%ANJO.GET_COMB_SPIN Combines ion data from two spins
...
%
%   [pefComb, dT] = ANJO.GET_COMB_SPIN(pef1, pef2, middleIndex, phi) also
%   returns the change in time from the start of pef1 to the start of
%   pefComb.
%
%   [pefComb, dT, newPhi] = ANJO.GET_COMB_SPIN(pef1, pef2, middleIndex, phi)
%   also returns a vector with new values for phi, corresponding to the new
%   spin.
%
%   See also ANJO.GET_PART_SPIN.
