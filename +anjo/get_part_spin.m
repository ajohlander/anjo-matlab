...
%ANJO.GET_PART_SPIN Get a partial spin
%   pefPart = ANJO.GET_PART_SPIN(pef,middleIndex, m, phi) returns ion data from a
...
%
%   [pefPart, deltaT] = ANJO.GET_PART_SPIN(pef,middleIndex, m, phi) also returns
%   the change in time from the start of pef to pefPart.
%
%   [pefPart, deltaT, newPhi] = ANJO.GET_PART_SPIN(pef,middleIndex, m, phi) also
%   returns a vector with new values for phi, corresponding to the new
%   partial spin.
%
%   See also ANJO.GET_COMB_SPIN.
