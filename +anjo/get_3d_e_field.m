...
%ANJO.GET_3D_E_FIELD returns 3D EFW data in ISR2.
%   bField = ANJO.GET_3D_E_FIELD(tint,scInd) - returns 3D electic field
%   for time interval tint and for spacecraft scInd.

%   See also: ANJO.PLOT_3D_E_FIELD, ANJO.GET_3D_E_FIELD,
%   ANJO.PLOT_3D_B_FIELD
