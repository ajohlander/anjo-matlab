...
%ANJO.HIA_PLOT_VELSPACE plot CIS-HIA data in velocity space.
%
%   ANJO.HIA_PLOT_VELSPACE(AX,F) plots ion data stored in F (matrix
...
%   energy resolution.
%
%   [hsf,hcb] = ANJO.HIA_PLOT_VELSPACE(psdMat,fn) returns axis handle for the
...
[th,phi,etab] = anjo.get_hia_values('all',eres);
u = irf_units;
